...
<!--datatable-->
  ...
  ?>
   ...
   <header id="header"><!--header-->
		<div class="header_top" style="background-color:#000000">
			<div class="container">
				<div class="row">
					<div class="col-sm-6">
		...
		<div class="header-bottom" style="background-color:#606060"><!--header-bottom-->
			<div class="container">
				<div class="row">
					<div class="col-sm-9">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        ...
                        <p>ATN is a toy store that is most popular with young people today with a number of stores spread across Vietnam.</p>
